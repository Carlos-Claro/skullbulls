...
/*my validation */
$lang['strong_pass']          = "O campo %s não é considerado seguro.";
$lang['email_check']       	  = "O campo %s não é válido, pois já está cadastrado.";
$lang['validadecc_check']     = "O campo %s deve conter uma Data válida.";
$lang['creditcards_check']    = "O campo %s não é um cartão de crédito válido.";
$lang['cpf_cnpj_check']       = "O campo %s não é válido, pois já está cadastrado.";
$lang['quantidade_check']     = "O campo %s deve conter um número maior que zero.";

...
class Cores_Model extends MY_Model
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->database = array('db' => 'skullbulls', 'table' => 'cores');
    }
...
//                                array('nome' => 'empresas',	'where' => 'rastreamento_transportadora.id_empresa = empresas.id ', 'tipo' => 'INNER'),
    ...
    {
        $data['coluna'] = 'cores.id as id, cores.titulo as descricao ';
        $data['tabela'] = array(
                                array('nome' => 'cores'),
        );

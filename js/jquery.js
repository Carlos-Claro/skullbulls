    ...
    <form action="" method="get">
      <fieldset>
        ...
        <div id="jq-compression" class="jq-clearfix">
          <input type="radio" name="name" value="http://code.jquery.com/jquery-1.8.1.min.js" id="jq-production" checked="checked">
          <a class="jq-radioToggle name jq-checked" href="http://code.jquery.com/jquery-1.8.1.min.js">jquery-1.8.1.min.js</a>
          <label for="jq-production">Production <em>(<strong>32KB</strong>, Minified and Gzipped)</em></label>
          <input type="radio" name="name" value="http://code.jquery.com/jquery-1.8.1.js" id="jq-development">
          <a class="jq-radioToggle name" href="http://code.jquery.com/jquery-1.8.1.js">jquery-1.8.1.js</a>
        ...
        <p class="jq-version"><strong>Current Release:</strong> v1.8.1</p>
      </fieldset>
    </form>
    <script>
    ...
    <ul>
      <li class="jq-clearfix" style="width:270px;float:left;clear:none;">
        <a href="http://link.packtpub.com/S3Fr9Q" class="jq-bookImg">
          <img src="./jquery_files/ljq3rded.jpg" alt="Learning jQuery Third Edition" width="55" height="70">
        </a>
        <h3>
      ...
      <li class="jq-clearfix" style="width:270px;float:left;clear:none;">
        <a href="http://www.packtpub.com/jquery-1-4-animation-techniques-beginners-guide/book/mid/1803111nkj15" class="jq-bookImg">
          <img src="./jquery_files/jquery-animation-beginners-guide.jpg" alt="jQuery 1.4 Animation Techniques: Beginners Guide" width="55" height="70">
        </a>
        <h3>
      ...
      <li class="jq-clearfix" style="width:270px;float:left;clear:none;">
        <a href="http://www.packtpub.com/jquery-plugin-development-beginners-guide/book/mid/1911104odmdz" class="jq-bookImg">
          <img src="./jquery_files/jquery-plugin-developers-guide_thumb.jpg" alt="jQuery Plugin Development Beginner&#39;s Guide" width="55" height="70">
        </a>
        <h3>
      ...
      <li class="jq-clearfix" style="width:270px;float:left;clear:left;">
        <a href="http://www.manning.com/affiliate/idevaffiliate.php?id=648_176" class="jq-bookImg">
          <img src="./jquery_files/jquery-in-action-2ed_thumb.jpg" alt="jQuery in Action" width="55" height="70">
        </a>
        <h3>
      ...
      <li class="jq-clearfix" style="width:270px;float:left;clear:none;">
        <a class="jq-bookImg" href="http://jqueryenlightenment.com/">
          <img src="./jquery_files/jquery-enlightenment_thumb.jpg" alt="jQuery Enlightenment" width="55" height="70">
        </a>
        <h3>
...
</body><span id="skype_highlighting_settings" display="none" autoextractnumbers="1"></span><object id="skype_plugin_object" location.href="http://jquery.com/" location.hostname="jquery.com" style="position: absolute; visibility: hidden; left: -100px; top: -100px; " width="0" height="0" type="application/x-vnd.skype.click2call.chrome.5.7.0"></object></html>